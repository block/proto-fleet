...
lab-fakes:
  ...
  trap 'kill 0' EXIT
  MDK_VERSION=1 HTTP_PORT=18081 SERIAL_NUMBER=PROTO-LAB-V1 FAKE_RIG_PASSWORD=admin1234 FAKE_RIG_MINING=1 /tmp/fakerig-lab &
  MDK_VERSION=2 HTTP_PORT=18082 SERIAL_NUMBER=PROTO-LAB-V2 FAKE_RIG_PASSWORD=admin1234 FAKE_RIG_MINING=1 /tmp/fakerig-lab &
  wait
