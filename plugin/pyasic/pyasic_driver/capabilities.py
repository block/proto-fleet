...
def build_capabilities(miner: Any) -> Capabilities:
    ...
    return {
        ...
        CAP_SET_POWER_TARGET: getattr(miner, "supports_power_modes", False),
...
# Static base capabilities used for describe_driver() before a miner is probed.
# Conservative: only flags that are always true regardless of miner type.
