...
const HbBayPreview = ({ data }: HbBayPreviewProps) => {
  return (
    <div className="mb-4 grid grid-cols-3 overflow-hidden rounded-xl border-1 border-border-10 phone:grid-cols-1 phone:gap-y-4 phone:rounded-none phone:shadow-none">
