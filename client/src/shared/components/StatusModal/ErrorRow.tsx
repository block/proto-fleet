...
const ErrorRow = ({
  ...
  const content = (
    <Row
      prefixIcon={icon}
      className="flex items-center justify-between text-emphasis-300"
      compact
      divider={divider}
    >
      <div className="min-w-0 flex-1 py-2 pr-2">
        ...
        {subtitle && (
          <div className="mt-0.5 text-200 text-text-primary-70">{subtitle}</div>
        )}
      </div>
      ...
      {onClick && (
        <div className="ml-2 shrink-0">
          <ChevronDown
            ...
            className="rotate-270 text-text-primary-70"
          />
        </div>
      )}
    </Row>
