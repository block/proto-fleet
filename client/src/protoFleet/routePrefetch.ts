...
export const importFleetNodesPage = () => import("@/protoFleet/features/fleetNodes/pages/FleetNodesPage");
export const importFleetNodeDetailPage = () => import("@/protoFleet/features/fleetNodes/pages/FleetNodeDetailPage");
