...
export const file_pairing_v1_pairing: GenFile =
  /*@__PURE__*/
  fileDesc(
    "",
 ...
 *
 * @generated from message pairing.v1.NetworkScanModeRequest
 */
export type NetworkScanModeRequest = Message<"pairing.v1.NetworkScanModeRequest"> & {
  /**
   ...
   * the supplied target.
   *
   * @generated from field: bool use_fleet_node_local_subnet = 3;
   */
  useFleetNodeLocalSubnet: boolean;
};

/**
 * Describes the message pairing.v1.NetworkScanModeRequest.
 * Use `create(NetworkScanModeRequestSchema)` to create a new message.
 */
export const NetworkScanModeRequestSchema: GenMessage<NetworkScanModeRequest> =
  /*@__PURE__*/
...
export type DiscoverRequest = Message<"pairing.v1.DiscoverRequest"> & {
  ...
  mode:
    ...
    | {
        /**
         * Discover using TCP network scanning
         *
         * @generated from field: pairing.v1.NetworkScanModeRequest network_scan = 4;
         */
        value: NetworkScanModeRequest;
        case: "networkScan";
      }
...
export type PairResponse = Message<"pairing.v1.PairResponse"> & {
   ...
   *
   * @generated from field: repeated string automatic_ip_recovery_ineligible_device_ids = 2;
   */
  automaticIpRecoveryIneligibleDeviceIds: string[];
};
