...
export const file_common_v1_common: GenFile =
  /*@__PURE__*/
  fileDesc(
    "",
  );
...
export type PlacementRefs = Message<"common.v1.PlacementRefs"> & {
  ...
  /**
   * @generated from field: common.v1.ResourceRef cohort = 6;
   */
  cohort?: ResourceRef | undefined;
};
