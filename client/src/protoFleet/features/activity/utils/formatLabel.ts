...
const labelMap: Record<string, string> = {
  ...
  "maintenance.ticket_created": "Created repair ticket",
  "maintenance.ticket_updated": "Updated repair ticket",
  "maintenance.ticket_deleted": "Deleted repair ticket",
  "maintenance.ticket_bulk_update": "Bulk updated repair tickets",
  "maintenance.comment_created": "Added repair ticket comment",
  "maintenance.comment_deleted": "Deleted repair ticket comment",
  "inventory.part_created": "Created inventory part",
  "inventory.part_updated": "Updated inventory part",
  "inventory.part_deleted": "Deleted inventory part",
  "inventory.parts_imported": "Imported inventory parts",
...
const filterLabelMap: Record<string, string> = {
  ...
  "maintenance.ticket_created": "Create repair ticket",
  "maintenance.ticket_updated": "Update repair ticket",
  "maintenance.ticket_deleted": "Delete repair ticket",
  "maintenance.ticket_bulk_update": "Bulk update repair tickets",
  "maintenance.comment_created": "Add repair ticket comment",
  "maintenance.comment_deleted": "Delete repair ticket comment",
  "inventory.part_created": "Create inventory part",
  "inventory.part_updated": "Update inventory part",
  "inventory.part_deleted": "Delete inventory part",
  "inventory.parts_imported": "Import inventory parts",
