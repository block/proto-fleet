    ...
    return (
      <div className="flex flex-col items-center gap-4 py-8">
        <span className="text-300 text-text-primary-70">
          Scan the local network to discover infrastructure devices
        </span>
        <Button
          text="Start scan"
  ...
  return (
    <div className="flex flex-col">
      <div className="border-b border-border-5">
        <div className="grid grid-cols-[auto_1fr_1fr_1fr] gap-4 px-2 py-2 text-200 font-medium text-text-primary-70">
          <span className="w-6" />
          <span>Device</span>
