...
describe("EfficiencyPanel", () => {
  ...
  it("shows subtitle when not all miners are reporting", () => {
    ...
    render(<EfficiencyPanel duration={"1h"} metrics={metrics} totalMiners={5} fleetDeviceCount={3} />);
  ...
  it("hides subtitle when all miners are reporting", () => {
    ...
    render(<EfficiencyPanel duration={"1h"} metrics={metrics} totalMiners={5} fleetDeviceCount={5} />);
  ...
  it("shows subtitle with zero miners reporting", () => {
    ...
    render(<EfficiencyPanel duration={"1h"} metrics={metrics} totalMiners={5} fleetDeviceCount={0} />);
