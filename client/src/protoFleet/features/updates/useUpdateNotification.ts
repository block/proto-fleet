...
import type { ReleaseInfo } from "@/protoFleet/api/generated/instance/v1/updates_pb";
...
export function useUpdateNotification(): UpdateNotificationState {
  ...
  const release =
    hasUpdatePermission && status?.statusAvailable && status.updateAvailable ? status.latestEligible : undefined;
