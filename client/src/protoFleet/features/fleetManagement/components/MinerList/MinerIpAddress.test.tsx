...
describe("MinerIpAddress", () => {
  ...
  it("renders a link to the IP address on HTTP port 80 when there is no URL", () => {
  ...
  it("renders a link that opens port 80 for HTTP URLs with non-UI ports", () => {
    const httpUrl = "http://192.168.1.100:4028";
  ...
  it("renders a link that opens port 80 for HTTPS URLs with non-UI ports", () => {
    const httpsUrl = "https://192.168.1.100:8080";
