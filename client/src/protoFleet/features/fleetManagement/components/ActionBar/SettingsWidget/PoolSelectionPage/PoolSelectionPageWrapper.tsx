...
interface PoolSelectionPageWrapperProps {
  ...
  userUsername?: string; // Required for bulk actions, optional for onboarding/individual miners
  userPassword?: string; // Required for bulk actions, optional for onboarding/individual miners
