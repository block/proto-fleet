...
describe("ActiveCurtailmentStatus", () => {
  ...
  it("renders restore progress with segment legend and unavailable annotation", () => {
    ...
    expect(restoredLegend.compareDocumentPosition(restoringLegend) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
    expect(restoringLegend.compareDocumentPosition(failedLegend) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
