...
test.describe("Racks - overview actions", () => {
  ...
  test(
    "Rack overview actions menu manages power for assigned rig miners",
    { tag: "@smoke" },
    async ({ racksPage, minersPage, page }) => {
      let rackLabel = "";
  ...
  test(
    "Rack overview actions menu opens manage security and validates password mismatch",
    { tag: "@smoke" },
    async ({ racksPage, loginModal, minersPage, page }) => {
      let rackLabel = "";
