...
test.describe("Proto Fleet - Fleet filters", () => {
  ...
  test("Buildings site filter scopes the list and clears cleanly @smoke", async ({ page, fleetLocationsPage }) => {
  ...
  test("Racks site and building filters can reach no results and then clear cleanly @smoke", async ({
    page,
    fleetLocationsPage,
    racksPage,
  }) => {
