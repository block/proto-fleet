...
test.describe("Proto Fleet - Add Miners Validation", () => {
  ...
  test("Back to editing button closes dialog and returns to form @smoke", async ({ minersPage, addMinersPage }) => {
  ...
  test("Continue anyway button proceeds with valid entries only @smoke", async ({
    minersPage,
    addMinersPage,
    page,
  }) => {
