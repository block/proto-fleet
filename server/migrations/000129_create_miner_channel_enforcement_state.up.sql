CREATE TABLE device_firmware_state (
    ...
    CONSTRAINT pk_device_firmware_state PRIMARY KEY (org_id, device_identifier),
...
CREATE TABLE device_config_state (
    ...
    CONSTRAINT pk_device_config_state PRIMARY KEY (org_id, device_identifier, dimension),
...
CREATE TABLE device_enforcement_state (
    ...
    CONSTRAINT ck_device_enforcement_state_desired_hash_nonempty
...
CREATE TABLE miner_channel_reconciler_heartbeat (
    ...
    CONSTRAINT ck_miner_channel_reconciler_heartbeat_singleton CHECK (id = 1)
);

INSERT INTO miner_channel_reconciler_heartbeat (id, last_tick_at, last_tick_uuid)
