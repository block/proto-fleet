-- Recreate device_ip_assignment table
CREATE TABLE device_ip_assignment (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    device_id BIGINT NOT NULL,
    ip_address VARCHAR(45) NOT NULL,
    port VARCHAR(10) NOT NULL,
    url_scheme VARCHAR(10) DEFAULT 'http',
...
-- Migrate IP assignment data back from discovered_device
...
WHERE dd.ip_address IS NOT NULL;
