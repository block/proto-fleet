...
DROP TRIGGER IF EXISTS device_firmware_deployment_deleted ON device_firmware_deployment;
...
DROP TRIGGER IF EXISTS firmware_rollout_device_deleted ON firmware_rollout_device;
