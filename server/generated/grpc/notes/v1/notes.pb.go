...
const file_notes_v1_notes_proto_rawDesc = "" +
	...
	"\fcom.notes.v1B\n" +
	"NotesProtoP\x01ZCgithub.com/block/proto-fleet/server/generated/grpc/notes/v1;notesv1\xa2\x02\x03NXX\xaa\x02\bNotes.V1\xca\x02\bNotes\\V1\xe2\x02\x14Notes\\V1\\GPBMetadata\xea\x02\tNotes::V1b\x06proto3"
...
var file_notes_v1_notes_proto_goTypes = []any{
	...
	(*UpdateNoteResponse)(nil),    // 6: notes.v1.UpdateNoteResponse
...
var file_notes_v1_notes_proto_depIdxs = []int32{
	9, // 0: notes.v1.Note.created_at:type_name -> google.protobuf.Timestamp
	9, // 1: notes.v1.Note.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: notes.v1.ListNotesResponse.notes:type_name -> notes.v1.Note
	0, // 3: notes.v1.CreateNoteResponse.note:type_name -> notes.v1.Note
	0, // 4: notes.v1.UpdateNoteResponse.note:type_name -> notes.v1.Note
	1, // 5: notes.v1.NoteService.ListNotes:input_type -> notes.v1.ListNotesRequest
	3, // 6: notes.v1.NoteService.CreateNote:input_type -> notes.v1.CreateNoteRequest
	5, // 7: notes.v1.NoteService.UpdateNote:input_type -> notes.v1.UpdateNoteRequest
	7, // 8: notes.v1.NoteService.DeleteNote:input_type -> notes.v1.DeleteNoteRequest
	2, // 9: notes.v1.NoteService.ListNotes:output_type -> notes.v1.ListNotesResponse
	4, // 10: notes.v1.NoteService.CreateNote:output_type -> notes.v1.CreateNoteResponse
	6, // 11: notes.v1.NoteService.UpdateNote:output_type -> notes.v1.UpdateNoteResponse
	8, // 12: notes.v1.NoteService.DeleteNote:output_type -> notes.v1.DeleteNoteResponse
