...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getCapabilityGroupsStmt, err = db.PrepareContext(ctx, getCapabilityGroups); err != nil {
		return nil, fmt.Errorf("error preparing query GetCapabilityGroups: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getCapabilityGroupsStmt != nil {
		if cerr := q.getCapabilityGroupsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getCapabilityGroupsStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getCapabilityGroupsStmt                             *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getCapabilityGroupsStmt:                             q.getCapabilityGroupsStmt,
