...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt, err = db.PrepareContext(ctx, insertCurtailmentTargetsForFullFleetCurtailmentPhase); err != nil {
		return nil, fmt.Errorf("error preparing query InsertCurtailmentTargetsForFullFleetCurtailmentPhase: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt != nil {
		if cerr := q.insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt: q.insertCurtailmentTargetsForFullFleetCurtailmentPhaseStmt,
