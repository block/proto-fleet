...
- `/api/v1/curtailment/config` - Curtailment service configuration (GET, PUT)
- `/api/v1/curtailment/status` - Latest curtailment status (GET; always reports no status received)
