...
func TestInstallWitnessSelectsOnlyEtcd(t *testing.T) {
	...
	for _, unexpected := range []string{"fleet-api", "fleet-client", "timescaledb.tar.gz", "proto-fleet-updater.service", updaterDropIn, haUpdaterDropIn, "proto-fleet-ha.service.d/keepalived.conf", "iputils-arping", " arping "} {
