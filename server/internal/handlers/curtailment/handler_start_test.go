...
func (s *startStubStore) ListEligibleConfirmationTargets(context.Context) ([]models.ConfirmationTarget, error) {
	panic("ListEligibleConfirmationTargets not exercised by handler Start tests")
}
