...
func toDeleteParams(req *pb.DeleteInventoryPartRequest, orgID int64) (models.DeleteParams, error) {
	expectedUpdatedAt := req.GetExpectedUpdatedAt()
	if expectedUpdatedAt == nil {
		return models.DeleteParams{}, fleeterror.NewInvalidArgumentError("expected_updated_at is required")
	}
	if err := expectedUpdatedAt.CheckValid(); err != nil {
		return models.DeleteParams{}, fleeterror.NewInvalidArgumentError("expected_updated_at is invalid")
	}
	return models.DeleteParams{
		ID:                req.GetId(),
		OrgID:             orgID,
		ExpectedUpdatedAt: expectedUpdatedAt.AsTime(),
	}, nil
}
