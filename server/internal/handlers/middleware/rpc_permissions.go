...
var ProcedurePermissions = map[string]string{
	...
	// MinerChannelService — read visibility uses miner_channel:read; lease and
	// membership mutations use miner_channel:manage.
	minerchannelv1connect.MinerChannelServiceGetMinerChannelProcedure:               authz.PermMinerChannelRead,
	minerchannelv1connect.MinerChannelServiceListMinerChannelsProcedure:             authz.PermMinerChannelRead,
	minerchannelv1connect.MinerChannelServiceGetMyMinerChannelsProcedure:            authz.PermMinerChannelRead,
	minerchannelv1connect.MinerChannelServiceListDevicesProcedure:                   authz.PermMinerChannelRead,
	minerchannelv1connect.MinerChannelServiceCreateMinerChannelProcedure:            authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceUpdateMinerChannelProcedure:            authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceSetMinerChannelFirmwareTargetProcedure: authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceAddDevicesToMinerChannelProcedure:      authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceRemoveDevicesFromMinerChannelProcedure: authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceReleaseMinerChannelProcedure:           authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceDeleteMinerChannelProcedure:            authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceAdminReassignProcedure:                 authz.PermMinerChannelManage,
	minerchannelv1connect.MinerChannelServiceAdminReleaseMinerChannelProcedure:      authz.PermMinerChannelManage,
