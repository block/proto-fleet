...
type PoolStore interface {
	...
	CreatePool(ctx context.Context, config *pb.PoolConfig, orgID int64, poolPriority int32, isDefault bool) (int64, error)
	UpdatePool(ctx context.Context, request *pb.UpdatePoolRequest, orgID int64) error
	UpdatePoolPriority(ctx context.Context, orgID int64, poolID int64, priority int32) error
	UnsetDefaultPool(ctx context.Context, orgID int64) error
