...
func (s *SQLFleetNodePairingStore) SetDiscoveredDeviceAttributionForDevice(ctx context.Context, fleetNodeID sql.NullInt64, deviceID, orgID int64) (int64, error) {
	return s.q(ctx).SetDiscoveredDeviceAttributionForDevice(ctx, sqlc.SetDiscoveredDeviceAttributionForDeviceParams{
		FleetNodeID: fleetNodeID,
		ID:          deviceID,
		OrgID:       orgID,
	})
...
func (s *SQLFleetNodePairingStore) UpsertDiscoveredDeviceFromFleetNode(ctx context.Context, orgID, fleetNodeID int64, report fleetnodepairing.DiscoveredDeviceReport) (int64, error) {
	return s.q(ctx).UpsertDiscoveredDeviceFromFleetNode(ctx, sqlc.UpsertDiscoveredDeviceFromFleetNodeParams{
		OrgID:                   orgID,
		Column2:                 report.DeviceIdentifier,
