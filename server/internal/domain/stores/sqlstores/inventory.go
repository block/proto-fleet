...
func (s *SQLInventoryStore) Create(ctx context.Context, params models.CreateParams) (*models.InventoryPart, error) {
	...
	if err != nil {
		...
		return nil, fleeterror.NewInternalErrorf("failed to create inventory part: %w", err)
	}
...
func (s *SQLInventoryStore) List(ctx context.Context, filter models.ListFilter) ([]models.InventoryPart, error) {
	...
	if err != nil {
		return nil, fleeterror.NewInternalErrorf("failed to list inventory parts: %w", err)
	}
...
func (s *SQLInventoryStore) Update(ctx context.Context, params models.UpdateParams) (*models.InventoryPart, error) {
	...
	if err != nil {
		...
		return nil, fleeterror.NewInternalErrorf("failed to update inventory part: %w", err)
	}
	if rows == 0 {
...
func (s *SQLInventoryStore) SoftDelete(ctx context.Context, orgID, id int64) (int64, error) {
	...
	if err != nil {
		return 0, fleeterror.NewInternalErrorf("failed to delete inventory part: %w", err)
	}
	if rows == 0 {
...
func (s *SQLInventoryStore) GetInsights(ctx context.Context, orgID int64) (*models.InventoryInsights, error) {
	...
	if err != nil {
		return nil, fleeterror.NewInternalErrorf("failed to get inventory insights: %w", err)
	}
...
func (s *SQLInventoryStore) ListPartsBySite(ctx context.Context, orgID, siteID int64) ([]models.InventoryPart, error) {
	...
	if err != nil {
		return nil, fleeterror.NewInternalErrorf("failed to list inventory parts by site: %w", err)
	}
	parts := make([]models.InventoryPart, 0, len(rows))
	for _, row := range rows {
...
func (s *SQLInventoryStore) Reserve(ctx context.Context, orgID, id int64, quantity int32) error {
	...
	if err != nil {
		return fleeterror.NewInternalErrorf("failed to reserve inventory part: %w", err)
	}
...
func (s *SQLInventoryStore) Release(ctx context.Context, orgID, id int64, quantity int32) error {
	...
	if err != nil {
		return fleeterror.NewInternalErrorf("failed to release inventory part: %w", err)
	}
...
func (s *SQLInventoryStore) ConsumeReserved(ctx context.Context, orgID, id int64, quantity int32) error {
	...
	if err != nil {
		return fleeterror.NewInternalErrorf("failed to consume reserved inventory part: %w", err)
	}
	return s.stockMutationResult(ctx, orgID, id, rows, "insufficient reserved stock")
}
...
func (s *SQLInventoryStore) ResolveSiteByName(ctx context.Context, orgID int64, name string) (int64, error) {
	...
	if err != nil {
		...
		return 0, fleeterror.NewInternalErrorf("failed to resolve inventory site: %w", err)
	}
	return id, nil
}
...
func (s *SQLInventoryStore) PartExistsBySiteAndName(ctx context.Context, orgID int64, siteID *int64, name string) (bool, error) {
	...
	if err != nil {
		return false, fleeterror.NewInternalErrorf("failed to check inventory part identity: %w", err)
	}
	return exists, nil
}
...
func (s *SQLInventoryStore) LockSites(ctx context.Context, orgID int64, siteIDs []int64) error {
	...
	if err != nil {
		return fleeterror.NewInternalErrorf("failed to lock inventory sites: %w", err)
	}
...
func inventoryGetError(err error, id int64) error {
	...
	return fleeterror.NewInternalErrorf("failed to get inventory part: %w", err)
}
