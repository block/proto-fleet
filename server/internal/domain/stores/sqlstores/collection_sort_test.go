...
func TestBuildCollectionListQuery_ErrorComponentTypes(t *testing.T) {
	...
	query, args := buildCollectionListQuery(1, pb.CollectionType_COLLECTION_TYPE_RACK, nil, "name", "ASC", 51, errorTypes)
...
func TestBuildCollectionCountQuery_ErrorComponentTypes(t *testing.T) {
	...
	query, args := buildCollectionCountQuery(1, pb.CollectionType_COLLECTION_TYPE_UNSPECIFIED, errorTypes)
	assert.Contains(t, query, "AND EXISTS")
