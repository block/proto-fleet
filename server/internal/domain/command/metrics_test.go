...
func TestEmitTerminalCommandSuccessAndFailure(t *testing.T) {
	...
	emitTerminalCommand(context.Background(), rec, commandtype.Reboot, nil)
	emitTerminalCommand(context.Background(), rec, commandtype.SetPowerTarget, errors.New("device offline"))
...
func TestNoCommandMetricsIsSafeToCall(t *testing.T) {
	emitTerminalCommand(context.Background(), NoCommandMetrics(), commandtype.Reboot, nil)
	emitTerminalCommand(context.Background(), nil, commandtype.Reboot, nil)
}
