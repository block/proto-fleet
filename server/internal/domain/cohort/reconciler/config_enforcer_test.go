...
func (*fakeConfigAdapter) Dimension() models.CohortConfigDimension          { return "test_dimension" }
func (*fakeConfigAdapter) HasDesiredState(*models.CohortDesiredConfig) bool { return true }
...
func TestConfigEnforcerNewRevisionDispatchesEvenWhenComparableStateMatches(t *testing.T) {
	...
	store := storemocks.NewMockCohortConfigEnforcementStore(ctrl)
