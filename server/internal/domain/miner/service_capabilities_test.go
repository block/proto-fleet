...
func (d *modelCapabilityDriver) GetCapabilitiesForModel(_ context.Context, model string) sdk.Capabilities {
	d.seenModel = model
	return d.modelCaps
}
...
func TestEffectiveCapabilitiesForDeviceUsesDriverCapsWithModelOverrides(t *testing.T) {
	...
	caps := service.effectiveCapabilitiesForDevice(t.Context(), "antminer", "Antminer S21")
