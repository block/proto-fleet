...
import (
	...
	commandtype "github.com/btc-mining/proto-fleet/server/internal/domain/commandtype"
	queue "github.com/btc-mining/proto-fleet/server/internal/infrastructure/queue"
...
func (mr *MockMessageQueueMockRecorder) Dequeue(ctx interface{}) *gomock.Call {
...
func (mr *MockMessageQueueMockRecorder) MarkFailed(ctx, messageID, errorInfo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMessageQueueMockRecorder) MarkSuccess(ctx, messageID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
