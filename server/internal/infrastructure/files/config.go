...
type Config struct {
	...
	MaxCommandArtifactSize         int64         `help:"Maximum fleet node command artifact size in bytes." default:"524288000" env:"MAX_COMMAND_ARTIFACT_SIZE"`
	CommandArtifactRetentionTTL    time.Duration `help:"TTL for finalized fleet node command artifacts." default:"168h" env:"COMMAND_ARTIFACT_RETENTION_TTL"`
	CommandArtifactCleanupInterval time.Duration `help:"Interval for finalized fleet node command artifact cleanup." default:"1h" env:"COMMAND_ARTIFACT_CLEANUP_INTERVAL"`
