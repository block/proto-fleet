...
func start(config *Config) error {
	...
	curtailmentRec := curtailmentReconciler.New(config.CurtailmentReconciler, curtailmentStore, commandSvc, curtailmentReconciler.WithMetrics(curtailmentMetrics))
