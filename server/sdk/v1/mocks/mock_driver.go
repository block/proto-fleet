...
//
//	mockgen -source=../interface.go -destination=mock_driver.go -package=mocks Driver,Device,DeviceCurtailment,DefaultCredentialsProvider,ModelCapabilitiesProvider
//
...
// MockDeviceCurtailment is a mock of DeviceCurtailment interface.
type MockDeviceCurtailment struct {
	ctrl     *gomock.Controller
	recorder *MockDeviceCurtailmentMockRecorder
	isgomock struct{}
}

// MockDeviceCurtailmentMockRecorder is the mock recorder for MockDeviceCurtailment.
type MockDeviceCurtailmentMockRecorder struct {
	mock *MockDeviceCurtailment
}

// NewMockDeviceCurtailment creates a new mock instance.
func NewMockDeviceCurtailment(ctrl *gomock.Controller) *MockDeviceCurtailment {
	mock := &MockDeviceCurtailment{ctrl: ctrl}
	mock.recorder = &MockDeviceCurtailmentMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDeviceCurtailment) EXPECT() *MockDeviceCurtailmentMockRecorder {
	return m.recorder
}
