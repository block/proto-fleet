import { ErrorListResponse, NotificationError } from "apiTypes";

import { getRowLabel } from "pages/Temperature/utility";
  ...
  if (error?.error_code) {
    ...
    switch (error.error_code) {
      ...
      case "AsicFailure":
        ...
        break;
      case "FanSlow":
        message = `Fan is running slow. Target RPM: ${details.fan_rpm_target}, Actual RPM: ${details.fan_rpm_tach}`;
        break;
      case "HashboardOverCurrent":
